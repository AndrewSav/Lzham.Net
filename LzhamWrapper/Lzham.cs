...
namespace LzhamWrapper
{
    public static class Lzham
    {
        ...
        public static CompressStatus СompressMemory(CompressionParameters parameters, byte[] inBuf, int inBufSize, int inBufOffset, byte[] outBuf, ref int outBufSize, int outBufOffset, ref uint adler32)
        {
